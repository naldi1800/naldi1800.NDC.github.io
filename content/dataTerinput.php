			...
			<div class="col-12">
              ...
              <div class="card-body">
                <table id="example1" class="table table-bordered table-striped">
                  ...
                  <tbody>
                  	<?php 	
						$sql = "SELECT * FROM peserta WHERE registrasi='No'";
  			         ...
  			         <tr>
	                    ...
	                    <td>
	                    	<a class="btn btn-app" data-toggle="modal" data-target="#re_regis<?= $row['id'] ?>">
			                  <img width="35" src="https://img.icons8.com/metro/100/000000/checked-user-male.png"/> Re-Registration
			                </a>
				        ...
				        <div class="modal-dialog">
				          <div class="modal-content">
				            ...
				            <div class="modal-body">
				              <p>Apa peserta atas nama "<?= $row['Nama'] ?>" sudah melakukan Registrasi Ulang  ?</p>
				            </div>
				            <div class="modal-footer justify-content-between">
				              <button type="button" class="btn btn-default" data-dismiss="modal">Batal</button>
				              <a href="config/re_regis.php?id=<?= base64_encrypt($row['id'], $key) ?>&c=Yes&page=<?php echo base64_encrypt('dataTerinput',$key)?>" type="button" class="btn btn-primary">Yes</a>
				            </div>
				          </div>
				        </div>
				      </div>
				      ...
				      <div class="modal fade" id="editUser<?= $row['id'] ?>">
				        <div class="modal-dialog">
				          <div class="modal-content">
				            ...
				            <div class="modal-footer justify-content-between">
				              <button type="button" class="btn btn-default" data-dismiss="modal">Batal</button>
				              <a href="?page=<?php echo base64_encrypt('editUser',$key)?>&id=<?= base64_encrypt($row['id'], $key) ?>&c=<?php echo base64_encrypt('dataTerinput',$key)?>" type="button" class="btn btn-primary">Yes</a>
				            </div>
				          </div>
				        </div>
				      </div>
				      ...
				      <div class="modal fade" id="deleteUser<?= $row['id'] ?>">
				        <div class="modal-dialog">
				          <div class="modal-content">
				            ...
				            <div class="modal-footer justify-content-between">
				              <button type="button" class="btn btn-default" data-dismiss="modal">Batal</button>
				              <a href="config/deleteUser.php?id=<?= base64_encrypt($row['id'], $key) ?>&page=<?php echo base64_encrypt('dataTerinput',$key)?>" type="button" class="btn btn-primary">Yes</a>
				            </div>
				          </div>
				        </div>
				      </div>
				      ...
				      <div class="modal fade" id="printUser<?= $row['id'] ?>">
				        <div class="modal-dialog">
				          <div class="modal-content">
				            ...
				            <div class="modal-footer justify-content-between">
				              <button type="button" class="btn btn-default" data-dismiss="modal">Batal</button>
				              <a href="config/printUser.php?id=<?= base64_encrypt($row['id'], $key) ?>&page=<?php echo base64_encrypt('dataTerinput',$key)?>" type="button" class="btn btn-primary">Yes</a>
				            </div>
				          </div>
				        </div>
				      </div>
...
<?php 
  if (isset($_SESSION['rereg'])) {
    if ($_SESSION['rereg'] == 'valid') {
      echo "<script>";
      echo "$(function () { 
        toastr.success('Data Berhasil Diregistrasi Ulang'); 
      }); ";
      echo "</script>";
    }else{
      echo "<script>";
      echo "$(function () { 
        toastr.error('Data gagal Diregistrasi Ulang'); 
      }); ";
      echo "</script>";
    }
